...
X_Validation, Y_Validation = X_Train[~msk], Y_Train[~msk]
np.save("./data/processed_train/validationInput", np.array(X_Validation))
np.save("./data/processed_train/validationOutput", np.array(Y_Validation))

print("Converted the Validation Data Input to pass to the NN for prediction at every sample. Shape of Validation data Input: ",X_Validation.shape)
print("Converted the Validation Data Output to pass to the NN for prediction at every sample. Shape of Validation data Output: ",Y_Validation.shape)

X_Train, Y_Train = X_Train[msk], Y_Train[msk]
np.save("./data/processed_train/trainInput", np.array(X_Train))
np.save("./data/processed_train/trainOutput", np.array(Y_Train))

print("Converted the Training Data Input to pass to the NN for prediction at every sample. Shape of Training data Input: ",X_Train.shape)
print("Converted the Training Data Output to pass to the NN for prediction at every sample. Shape of Training data Output: ",Y_Train.shape)
